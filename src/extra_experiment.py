...
def save_plots(train_losses, val_losses, val_accuracies, val_macro_f1s):
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.title("TF-IDF (1,2)-gram + MLP Loss Curve")
    plt.legend()
    plt.tight_layout()
    plt.savefig("figures/tfidf_bigram_mlp_loss_curve.png")
    plt.close()
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Score")
    plt.title("TF-IDF (1,2)-gram + MLP Validation Metrics")
    plt.legend()
    plt.tight_layout()
    plt.savefig("figures/tfidf_bigram_mlp_validation_metrics.png")
    plt.close()
...
def main():
    ...
    print("Building TF-IDF bigram features...")
    ...
    print(f"TF-IDF bigram train shape: {X_train_tfidf.shape}")
    print(f"TF-IDF bigram val shape: {X_val_tfidf.shape}")
    print(f"TF-IDF bigram test shape: {X_test_tfidf.shape}")
    ...
    with open("results/tfidf_bigram_mlp_results.txt", "w", encoding="utf-8") as f:
        f.write("TF-IDF (1,2)-gram + MLP Results\n")
        f.write("===============================\n\n")
        f.write(f"TF-IDF bigram train shape: {X_train_tfidf.shape}\n")
        f.write(f"TF-IDF bigram val shape: {X_val_tfidf.shape}\n")
        f.write(f"TF-IDF bigram test shape: {X_test_tfidf.shape}\n")
    ...
    print("\nResults saved to results/tfidf_bigram_mlp_results.txt")
    print("Plots saved to figures/tfidf_bigram_mlp_loss_curve.png")
    print("Plots saved to figures/tfidf_bigram_mlp_validation_metrics.png")
